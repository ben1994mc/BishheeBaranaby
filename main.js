...
function checkAvailability(disp_id) {
         ...
         var storedData2; // save the form again just in case
    storedData2 = getObject('checkAvailability'+newIndex);
     get_numbers('http://localhost:8081/get_numbers', storedData2, disp_id);
